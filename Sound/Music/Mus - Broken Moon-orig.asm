BrokenMoon_Header:
	...
	smpsHeaderFM        BrokenMoon_FM1,	$00, $00
	smpsHeaderFM        BrokenMoon_FM2,	$00, $00
	smpsHeaderFM        BrokenMoon_FM3,	$00, $08
	smpsHeaderFM        BrokenMoon_FM4,	$00, $00
	smpsHeaderFM        BrokenMoon_FM5,	$00, $00
	smpsHeaderFM        BrokenMoon_FM6,	$00, $00
	smpsHeaderPSG       BrokenMoon_PSG1,	$00, $00, $00, $00
	smpsHeaderPSG       BrokenMoon_PSG2,	$00, $00, $00, $00
	smpsHeaderPSG       BrokenMoon_PSG3,	$00, $00, $00, fTone_01
...
BrokenMoon_DAC:
	...
	dc.b	$04
	smpsSetTempoMod     $07
	dc.b	$18, dSnare, $06, dKick, $03, $03, $85, dKick

BrokenMoon_Loop00:
	dc.b	dKick, $06, $09

BrokenMoon_Loop01:
	dc.b	$03, $84, $06, dLowTimpani, $03, dKick, $06, $03, $06, $84
	smpsLoop            $00, $08, BrokenMoon_Loop00
	dc.b	dKick, $03, dSnare, dKick, $09
	smpsLoop            $01, $02, BrokenMoon_Loop01

BrokenMoon_Loop02:
	dc.b	$03, $84, $06, dLowTimpani, $03, dKick, $06, $03, $06, $84, dKick, dKick
	dc.b	$09
	smpsLoop            $00, $06, BrokenMoon_Loop02
	dc.b	$03, $84, $06, dLowTimpani, $03, dKick, $06, $03, $06, $84, dKick, dKick
	dc.b	$03, dSnare, dSnare, dKick, $84, dSnare, dSnare, dKick, $06, $02, dSnare, $01
...
BrokenMoon_Loop03:
	dc.b	$09, $03, $84, $06, dLowTimpani, $03, dKick, $06, $03, $06, $84, dKick
	smpsLoop            $00, $07, BrokenMoon_Loop03
	dc.b	$09, $03, $84, $06, dLowTimpani, $03, dKick, $06, $03, $06, $84
