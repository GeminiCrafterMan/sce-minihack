DEZ_DoAniPLC:
	...
	subq.b	#1,d0
	andi.b	#3,d0
	lea	(Art_DEZAcid2).l,a4 ; load lava patterns
	ror.w	#7,d0
	adda.w	d0,a4
...
AniPLC_DEZ:	zoneanimstart
	;Acid surface
	zoneanimdecl -1, (Art_DEZAcid1>>1), $33D, 3, 8
	dc.b   0,$13
	dc.b   8,$13
	dc.b  16,$13
	even
	; big fan
	zoneanimdecl 4, (Art_DEZFan>>1), $1F4, 4, 52
	dc.b	0
	dc.b	52
	dc.b	104
	dc.b	156
