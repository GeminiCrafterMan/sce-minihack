...
DLE_EHZEX:
		...
		jmp	.index(pc,d0.w)
; ===========================================================================
.index:	dc.w DLE_EHZEXmain-.index
		dc.w DLE_EHZEXboss-.index
		dc.w DLE_EHZEXend-.index
; ===========================================================================
...
EHZ1_BackgroundInit:
		...
		bra.s	EHZ1_BackgroundEvent.deform

; =============== S U B R O U T I N E =======================================

EHZ1_BackgroundEvent:
		tst.b (Background_event_flag).w
		bne.s	EHZ1_Transition
		bsr.w	EHZ_Deform

.deform:
		lea	EHZ1_BGDeformArray(pc),a4
...
EHZ1_Transition:
	...
	.ret:
		bsr.w	EHZ_Deform
		bra.w	EHZ1_BackgroundEvent.deform
; ---------------------------------------------------------------------------
