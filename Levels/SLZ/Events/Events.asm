...
DLE_SLZEX:
		...
		jmp	.index(pc,d0.w)
; ===========================================================================
.index:	dc.w DLE_SLZEXmain-.index
		dc.w DLE_SLZEXboss-.index
		dc.w DLE_SLZEXend-.index
; ===========================================================================
...
SLZ1_BackgroundInit:
		...
		bra.s	SLZ1_BackgroundEvent.deform
...
SLZ1_Transition:
	...
	.ret:
		bsr.w	SLZ_Deform
		bra.w	SLZ1_BackgroundEvent.deform
; ---------------------------------------------------------------------------
