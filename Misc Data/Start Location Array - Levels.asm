...
StartLocArray:
		...
		binclude "Levels/BGZ/Start Location/1.bin"	; BGZ 1
		binclude "Levels/BGZ/Start Location/1.bin"	; BGZ 2
		binclude "Levels/BGZ/Start Location/1.bin"	; BGZ 3
		binclude "Levels/BGZ/Start Location/1.bin"	; BGZ 4
