...
Sonic_BalanceOnObjRight:
		...
		blt.w	Sonic_ResetScr			; if so branch
...
Sonic_BalanceOnObjLeft:
		...
		bge.w	Sonic_ResetScr	; if so branch (instruction signed to match)
		move.b	#id_Balance2,anim(a0)	; if REALLY close to the edge, use different animation (Balance animation 2)
		bra.w	Sonic_ResetScr
loc_11166:	; +
		; Somewhat dummied out/redundant code from Sonic 2
...
+
	...
	.playerLUT:
		dc.l	Sonic_InstaAndShieldMoves, locret_118E8, Knux_Test_For_Glide
...
ReloadPlayerMaps:
	...
	.mapLUT:
		dc.l	Map_Sonic, Map_Sonic, Map_Knuckles
	.superMapLUT:
		dc.l	Map_Sonic, Map_Sonic, Map_Knuckles
...
PlayerDPLCToA2:
	...
	.plcLUT:
		dc.l	PLC_Sonic, PLC_Sonic, PLC_Knuckles
	.superplcLUT:
		dc.l	PLC_Sonic, PLC_Sonic, PLC_Knuckles
...
PlayerArtToD6:
	...
	.artLUT:
		dc.l	ArtUnc_Sonic>>1, ArtUnc_Sonic>>1, ArtUnc_Knuckles>>1
	.superartLUT:
		dc.l	ArtUnc_Sonic>>1, ArtUnc_Sonic>>1, ArtUnc_Knuckles>>1
